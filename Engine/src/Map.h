...
{
public:
    Map(World* InOwningWorld, const std::string& InPath = "", const int InMapWidth = 0, const int InMapHeight = 0);
     ...
     */
    void Init(const std::string& InPath, const int InMapWidth, const int InMapHeight);
     ...
     */
    std::vector<std::vector<char>>* GetMap() { return &m_MapLayout; }
...
private:
    ...
    std::vector<std::vector<char>> m_MapLayout;
};

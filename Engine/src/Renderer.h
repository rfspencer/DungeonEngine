...
{
public:
    Renderer(std::wstring InTitle = L"Dungeon Engine", short InWindowWidth = 120, short InWindowHeight = 30);
...
private:
     ...
     *
     * The render buffer is a std::vector of CHAR_INFO structures with a size of m_WindowWidth * m_WindowHeight.
     * It is used to store the character information for each position in the window.
     */
    std::vector<CHAR_INFO> m_RenderBuffer;
